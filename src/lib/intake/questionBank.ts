...
export const QUESTION_BANK: ComplaintDefinition[] = [
  ...
  },
  {
    ...
    questions: [
      {
        id: "q1",
        field: "history_bundle",
        en: "Please tell me three things: since when, any medicine taken, and whether this happens often?",
        hi: "कृपया तीन बातें बताएं: यह कब से है, कोई दवा ली है या नहीं, और क्या यह अक्सर होता है?",
        chips_en: ["A few days, no medicine, first time", "A few days, no medicine, happens often", "Long-standing, taking medicine"],
        chips_hi: ["कुछ दिनों से, दवा नहीं, पहली बार", "कुछ दिनों से, दवा नहीं, अक्सर होता है", "काफी समय से, दवा चल रही है"],
      },
      {
        id: "q2",
        field: "notes",
        en: "Anything else you want the doctor to know, or do you need tests?",
        hi: "डॉक्टर को और कुछ बताना है, या जांच करानी है?",
